      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item
            ...
            v-if="Object.keys(getLoginUser).length !== 0 && getLoginUser.role === 'EMPLOYER'"
          >
          ...
          <b-nav-item
            ...
            v-if="Object.keys(getLoginUser).length !== 0 && getLoginUser.role === 'EMPLOYEE'"
          >
            <font-awesome-icon icon="outdent"></font-awesome-icon>
            <span class>Dashboard</span>
          </b-nav-item>
          ...
          >
            <template slot="button-content">
              ...
              <span class>{{ getLoginUser.firstName }} {{ getLoginUser.lastName }}</span>
            </template>
