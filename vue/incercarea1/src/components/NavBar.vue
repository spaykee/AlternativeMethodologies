      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item
            ...
            v-if="
              Object.keys(getLoginUser).length !== 0 &&
                getLoginUser.role === 'EMPLOYER'
            "
          >
          ...
          <b-nav-item
            ...
            :class="this.$route.name == 'dashboardemployee' ? 'active' : ''"
            v-if="
              Object.keys(getLoginUser).length !== 0 &&
                getLoginUser.role === 'EMPLOYEE'
            "
          >
            <font-awesome-icon icon="outdent"></font-awesome-icon>
            <span class>Dashboard</span>
          ...
          <b-nav-item-dropdown
            id="mydiv"
            ref="myid"
            :class="checkTestsActiveRoute ? 'active' : ''"
            v-if="Object.keys(getLoginUser).length !== 0"
            left
          >
            ...
            <b-dropdown-item
              to="/testBelbin"
              :class="this.$route.name == 'testBelbin' ? 'active' : ''"
              >Belbin</b-dropdown-item
            >
            <b-dropdown-item
              to="/testMbti"
              :class="this.$route.name == 'testMbti' ? 'active' : ''"
              >MBTI</b-dropdown-item
            >
            <b-dropdown-item
              to="/testEnneagram"
              :class="this.$route.name == 'testEnneagram' ? 'active' : ''"
              >Enneagram</b-dropdown-item
            >
          </b-nav-item-dropdown>

          <b-nav-item-dropdown
            :class="checkAboutActiveRoute ? 'active' : ''"
            left
          >
            <template slot="button-content">
            ...
            <b-dropdown-item
              to="/aboutBelbin"
              :class="this.$route.name == 'aboutBelbin' ? 'active' : ''"
              >Belbin</b-dropdown-item
            >
            <b-dropdown-item
              to="/aboutMbti"
              :class="this.$route.name == 'aboutMbti' ? 'active' : ''"
              >MBTI</b-dropdown-item
            >
            <b-dropdown-item
              to="/aboutEnneagram"
              :class="this.$route.name == 'aboutEnneagram' ? 'active' : ''"
              >Enneagram</b-dropdown-item
            >
            <b-dropdown-divider></b-dropdown-divider>
            <b-dropdown-item
              to="/aboutZodiac"
              :class="this.$route.name == 'aboutZodiac' ? 'active' : ''"
              >Zodiac</b-dropdown-item
            >
            <b-dropdown-item
              to="/aboutZodiacAsc"
              :class="this.$route.name == 'aboutZodiacAsc' ? 'active' : ''"
              >Zodiac Ascendents</b-dropdown-item
            >
            <b-dropdown-item
              to="/aboutNumerology"
              :class="this.$route.name == 'aboutNumerology' ? 'active' : ''"
              >Numerology</b-dropdown-item
            >
          </b-nav-item-dropdown>

          <b-nav-item
            to="/contact"
            :class="this.$route.name == 'contact' ? 'active' : ''"
          >
          ...
          <b-nav-item
            to="/signin"
            :class="this.$route.name == 'signin' ? 'active' : ''"
            v-if="Object.keys(getLoginUser).length === 0"
          >
          ...
          <b-nav-item-dropdown
            ...
            v-if="Object.keys(getLoginUser).length !== 0"
            ref="myid"
            :class="checkUserActiveRoute ? 'active' : ''"
            right
          >
            <template slot="button-content">
              <font-awesome-icon icon="user-tie"></font-awesome-icon>
              <span class
                >{{ getLoginUser.firstName }} {{ getLoginUser.lastName }}</span
              >
            </template>
            <b-dropdown-item
              to="/editUser"
              :class="this.$route.name == 'editUser' ? 'active' : ''"
            >
            ...
            <b-dropdown-item
              to="/testResults"
              :class="this.$route.name == 'testResults' ? 'active' : ''"
            >
