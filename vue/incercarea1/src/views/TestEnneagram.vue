<template>
    <div id="testEnneagram" :key="componentKey">
             ...
             <b-row class="mb-3" id="info">
                <b-col sm="12" >      
                    <b-card title="The Riso-Hudson Enneagram Type Indicator" header-tag="" footer-tag="">
                        <b-card-text>        
                             <p>The RHETI Sampler’s 36 questions are only a part of the full, independently scientifically validated 144-question Riso-Hudson Enneagram Type Indicator (RHETI, Version 2.5) personality inventory.</p>          
                             <p>Short personality quizzes such as the RHETI Sampler cannot guarantee that your basic personality type will be indicated, although your type will most likely be one of the top three scores in this free quiz.</p>                   
                             <p>We recommend that you read the type descriptions at the end of this test, and in Riso-Hudson Enneagram books, to help you identify your basic personality type.</p>                   
                             <p>Remember that there are no “right” answers and that no personality type is better than any other. Furthermore, the RHETI does not indicate how healthy or unhealthy a person is, so relax and answer the statements simply and honestly. </p>        
                        </b-card-text>
                    </b-card>
                </b-col>
            </b-row>
        ...
        <b-modal ref="my-modal" hide-footer header-bg-variant="danger" title="Enneagram test completed successfully!">
...
export default {
    ...
    methods: {
        ...mapActions(["setUserEnneagramSequance", "addUserEnneagram", "computeEnneagramType"]),
           ...
           if (this.formValid){
                this.questions.forEach((q, i) => {                                            
                    let ue = {
                        ...
                        answerEnneagramType: q.answers.filter(a => a.answerId === q.selectedAnswerId)[0].enneagramType
                    }                
    ...
    computed: {
        ...mapGetters(["getAllEnneagramAnswers", "getAllEnneagramQuestions", "getUserEnneagramSequance", "getLoginUser", "getTestCompleted"]),
    },
    mounted() {  
        let questions = [];
