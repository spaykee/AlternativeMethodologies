                           ...
                           <b-row>
                                <b-col sm="6" v-for="(q, key) in questions" :key="key">
                                    <b-form-group>
                                        ...
                                        <b-form-radio class="ml-4" @input="checkForm" v-for="(a, j) in q.answers" :key="j" v-model="q.selectedAnswerId" :name="'answer-'+key+'-'+'j'" :value="a.answerId"><span class="pointer">{{a.answerText}}</span></b-form-radio>                                                                                
                                    </b-form-group>
                                </b-col>                                 
                            </b-row>
                        </b-card-text>
