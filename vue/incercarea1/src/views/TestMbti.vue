<template>
  <div id="testMbti" :key="componentKey">
        ...
        <b-col sm="10" offset="1">
          <b-card title="MBTI Personality Test" header-tag footer-tag>
            <b-card-text>
              ...
              <p>
                Answer the questions quickly, do not over-analyze them. Some
                seem worded poorly. Go with what feels best.
              </p>
              <p>
                Answer the questions as “the way you are”, not “the way you’d
    ...
    <b-modal
      ...
      title="MBTI test completed successfully!"
    >
