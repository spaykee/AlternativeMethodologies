    ...
    <b-container>
      ...
      <b-card class="mt-4" header-tag="header">
        <template v-slot:header>
          <h2 class="mb-0">How the Enneagram System Works</h2>
        </template>
        <b-card-text class="about-enneagram">
          <p>The Enneagram is a profoundly powerful personality system that describes nine distinctly different personality types, each with unique mental, emotional and behavioral patterns that tend to become habitual over time and distort reality as it actually is. The Enneagram also describes how and why these patterns arise in the first place, although that is too big a topic to get into on this website (for more information read any books by Sandra Maitri, especially "The Spiritual Dimension of the Enneagram," and/or any books by A.H. Almaas). At first the Enneagram may seem like any other personality system but it gets much more subtle and deep as you probe into it. The Enneagram can act as a powerful mirror to help us see the hidden nature of our own personality structure, but more importantly, it can be used as a self-awareness tool to help us let go of our personality type's habitual ways of being that don't serve us.... or the world.</p>
          <b-img src="../assets/enneagram.png" center alt="Enneagram" style="width: 50%"></b-img>
        </b-card-text>
        <b-col class="my-5">
          <b-card-group deck>
            <!--Type One-->
            <b-card class="type-one" header-tag="header">
              <template v-slot:header>
                <h6 class="mb-0">Type One</h6>
              </template>
              <b-card-text class>
                <p>
                  Ones are conscientious
                  <b>PERFECTIONISTS</b> motivated by a desire to live their life the right way, which includes improving themselves, others, and the world around them. They try to avoid criticism by doing things perfectly. They have a strong inner critic/conscience and live by their internal dictates of "shoulds" and "shouldn'ts." They discipline themselves to do what ought to be done. They do everything they can to avoid: showing anger, losing self-control, or making mistakes. Unconscious focus of attention: noticing imperfections; correcting errors; doing a job well; being competent; having integrity.
                </p>
              </b-card-text>
            </b-card>
            <!--Type Two-->
            <b-card class="type-two" header-tag="header">
              <template v-slot:header>
                <h6 class="mb-0">Type Two</h6>
              </template>
              <b-card-text class>
                <p>
                  Twos are friendly
                  <b>ADVISORS</b> motivated by a desire to be loved and appreciated for their selfless generosity and helpfulness. They take pride in their ability to make people feel special and to anticipate and fulfill other people's needs. They like to express their positive feelings toward others and usually appear cheerful and self-sufficient. They can be so busy taking care of others that they are often unaware of their own real needs. They do everything they can to avoid: disappointing others, feeling rejected, and being seen as needy, clingy or possessive. Unconscious focus of attention: anticipating/fulfilling needs of others; making others feel special; establishing warm, heartfelt connections.
                </p>
              </b-card-text>
            </b-card>
            <!--Type Three-->
            <b-card class="type-three" header-tag="header">
              <template v-slot:header>
                <h6 class="mb-0">Type Three</h6>
              </template>
              <b-card-text class>
                <p>
                  Threes are ambitious
                  <b>ACHIEVERS</b> motivated by a desire to be productive, efficient, admired, and successful at whatever they do. Life is a series of tasks and goals to be completed and they keep pushing themselves to achieve more. Diplomatic, image-conscious Threes like to shine and want to be esteemed by others. They are often disconnected from their deeper feelings and can lose an inner sense of themselves. They do everything they can to avoid: failure and uncomfortable feelings that may arise from slowing down their pace. Unconscious focus of attention: optimal performance; achieving goals; winning; multitasking; efficient functioning; creating a successful image.
                </p>
              </b-card-text>
            </b-card>
          </b-card-group>
