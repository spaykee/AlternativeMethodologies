                   ...
                   <b-card no-body>
                        <b-tabs  v-model="tabIndex" card>
                            <b-tab active class="scrollable">
                                <template slot="title">
                                    Unassigned employees <b-badge pill variant="danger">{{unasignedUsersItems.length}}</b-badge>
                                </template>
                                <div >
                                    ...
                                    >
                                        ...
                                        <template v-slot:cell(actions)="row">                                                
                                            ...
                                            <b-button v-if="!row.item.selected" variant="outline-secondary" size="sm" @click="selectRow(row.item)">
                                                <font-awesome-icon icon="circle"></font-awesome-icon>
                                            </b-button>
                                             <b-button v-if="row.item.selected" variant="success" size="sm" @click="selectRow(row.item)">
                            ...
                            <b-tab class="scrollable">
                                <template slot="title">
                                   All employees <b-badge pill variant="primary">{{allUsersItems.length}}</b-badge>
                                </template>
                                <div>
                                    ...
                                    <b-form-group label-cols-sm="6" label="" class="mt-1">
                                        <b-input-group>
                                            <b-input-group-append>
                                                <b-form-select v-model="searchAllUsersKey" :options="searchAllUsersKeyOptions"></b-form-select>
                                            </b-input-group-append>
                                            <b-form-input v-model="allUsersFilter" placeholder="Search..."></b-form-input>
                                            <b-input-group-append>
                                                <b-button :disabled="!allUsersFilter" @click="allUsersFilter = ''">Clear</b-button>
                                            </b-input-group-append>
                                        </b-input-group>
                                    </b-form-group>
                                    ...
                                    >
                                        ...
                                        <template v-slot:cell(actions)="row">                                                
                                            ...
                                            <b-button variant="outline-danger" size="sm" @click="removeUser(row.item)">
                            ...
                            <b-tab class="scrollable">
                                <template slot="title">
                                    Assigned employees <b-badge pill variant="success">{{assignedUsersItems.length}}</b-badge>
                                </template>
                                <div>
                                     ...
                                     <b-form-group label-cols-sm="6" label="" class="mt-1">
                                        <b-input-group>
                                            <b-input-group-append>
                                                <b-form-select v-model="searchAssignedKey" :options="searchAssignedKeyOptions"></b-form-select>
                                            </b-input-group-append>
                                            <b-form-input v-model="assignedFilter" placeholder="Search..."></b-form-input>
                                            <b-input-group-append>
                                                <b-button :disabled="!assignedFilter" @click="assignedFilter = ''">Clear</b-button>
                                            </b-input-group-append>
                                        </b-input-group>
                                    </b-form-group>
                                    ...
                                    >
                                        ...
                                        <template v-slot:cell(actions)="row">                                                
                                           ...
                                           <b-button variant="outline-danger" size="sm" @click="removeUserFormTeam(row.item)">
                        ...
                        <div slot="footer">
                            <b-row v-if="tabIndex === 0">
                                <b-col md="4" class="my-1">
                                    <b-form-group label-cols-sm="7" label="Records / page" class="mb-0">
                            ...
                            <b-row v-if="tabIndex === 1">
                                <b-col md="4" class="my-1">
                                    <b-form-group label-cols-sm="7" label="Records / page" class="mb-0">
                                    <b-form-select v-model="perAllUsersPage" :options="pageOptions"></b-form-select>
                                    </b-form-group>
                                </b-col>
                                <b-col md="8" class="my-1">
                                    <b-pagination
                            ...
                            <b-row v-if="tabIndex === 2">
                                <b-col md="4" class="my-1">
                                    <b-form-group label-cols-sm="7" label="Records / page" class="mb-0">
                                    <b-form-select v-model="perAssignedPage" :options="pageOptions"></b-form-select>
                                    </b-form-group>
                                </b-col>
                                <b-col md="8" class="my-1">
                                    <b-pagination
                    ...
                    <b-card no-body> 
                        <b-tabs card>
                            <b-tab title="Create a team" class="scrollable">
                                <div>
                                    <b-form-group label-cols-sm="6" label="Team title" class="mt-1">
                                        <b-input-group>
                                            <b-form-input v-model="newTeamName" ></b-form-input>
                                            <b-input-group-append>
                                                <b-button variant="primary" :disabled="!newTeamName" @click="submitNewTeam">Create</b-button>
                                            </b-input-group-append>
                                        </b-input-group>
                                    </b-form-group>
                                </div>
                            ...
                            <b-tab title="All teams" active class="scrollable">
                                <div>           
                                   ...
                                   <b-form-group label-cols-sm="6" label="Team title" class="mt-1">
                                        <b-input-group>
                                            <b-form-input :disabled="true" v-model="teamTitle"></b-form-input>
                                        </b-input-group>
                                    </b-form-group>
                        ...
                        <div slot="footer">
                            <b-row>
                                <b-col md="2" class="my-1">
                                    <b-button variant="success" :disabled="teamTitle === ''" @click="addUserToTeam"><font-awesome-icon icon="sign-in-alt"></font-awesome-icon></b-button>
                                </b-col>
                                <b-col md="5" class="my-1">
                                    <b-form-group label-cols-sm="6" label="Select a team" class="my-0">
                                        <b-form-input list="input-list" v-model="selectedTeam" @change="selectTeam" placeholder="Search..." id="input-with-list"></b-form-input>
                                        <b-form-datalist id="input-list" :options="allTeams"></b-form-datalist>
                                    </b-form-group>
                                </b-col>
                                <b-col md="5" class="my-1">
                                    <b-row>
                                        <b-col md="6" class="">
                                            <b-form-input min="0" v-model="teamMembersCount" type="number"></b-form-input>
                                        </b-col>
                                        <b-col md="6" class="">
                                            <b-button :disabled="teamTitle === '' || parseInt(teamMembersCount) === 0 || unasignedUsersItems.length < parseInt(teamMembersCount)" @click="autoTeamGenerator" variant="warning"><font-awesome-icon icon="cogs"></font-awesome-icon> Auto</b-button>
                                        </b-col>
                                    </b-row>
                                </b-col>
                            </b-row>         
...
export default {
    ...
    data() {
        return {
            ...
            allUsersFields: [
                { key: 'name', label: 'Employee full name', sortable: true, sortDirection: 'asc', class: 'text-center' },
                { key: 'position', label: 'Position', sortable: true, sortDirection: 'asc', class: 'text-center' },
                { key: 'assigned', label: 'Assigned', sortable: true, sortDirection: 'asc', class: 'text-center' },
                { key: 'actions', label: 'Actions', class: 'text-center' }
            ],
            ...
            assignedUsersFields: [
                { key: 'name', label: 'Employee full name', sortable: true, sortDirection: 'asc', class: 'text-center' },
                { key: 'position', label: 'Position', sortable: true, sortDirection: 'asc', class: 'text-center' },
                { key: 'teamName', label: 'Team Name', sortable: true, sortDirection: 'asc', class: 'text-center' },
                { key: 'actions', label: 'Actions', class: 'text-center' }
            ],
        }
    },
    methods: {
        ...
        selectRow(item) {
            this.unasignedUsersItems.filter(i => i.key === item.key)[0].selected = !this.unasignedUsersItems.filter(i => i.key === item.key)[0].selected;
        },       
        ...
        getAssignedUsers() {
            let employerUsers = this.getAllUsers.filter(us => us.employerCode === this.getLoginUser.code);
        ...
        getTeamUsers() {
            ...
            let teamUsers = employerUsers.filter(eu => eu.teamName === this.teamTitle);     
        ...
        addUserToTeam() {           
         ...
         removeUserFormTeam(item) {
            this.$bvModal.msgBoxConfirm('Please confirm that you want to remove this user from this team?', {
            ...
            .then(value => {
                if (value){
                    let toUpdateUser = this.getAllUsers.filter(u => u.id === item.id)[0];
        ...
        removeUser(item) {
            this.$bvModal.msgBoxConfirm('Please confirm that you want to remove this user from your emplyment?', {
                title: 'Please Confirm!',
                buttonSize: 'sm',
                okVariant: 'danger',
                okTitle: 'YES',
        ...
        autoTeamGenerator() {
            ...
            let belbGroup = [pplOrientedUsers, actionOrientedUsers, thoughtOrientedUsers];

            belbGroup.sort(function(a, b){return b.length - a.length});
            ...
            possibleTeams.forEach(group => {
                ...
                comb.forEach(c => {
                    mbtiGroupScore += parseInt(mbticompObj.matrix[mbticompObj.x.indexOf(c[0].mbti.code)][mbticompObj.x.indexOf(c[1].mbti.code)]);
                    enneagramGroupScore += parseInt(enneagramcompObj[parseInt(c[0].enneagram.id) - 1][parseInt(c[1].enneagram.id) - 1]);
                });
            ...
            newPossibleTeams.sort(function(a, b){return b.totalScore - a.totalScore});
    ...
    computed: {
        ...mapGetters(["getEnneagramCompatibility", "getMbtiCompatibility", "getLoginUser", "getTeams", "getAllUsers", "getAllUserDatasets", "getAllZodiacs", "getAllZodiacAscendants", "getAllEnneagrams", "getAllMbtis", "getAllBelbins", "getAllNumerologys"]),
        sortOptions() {
