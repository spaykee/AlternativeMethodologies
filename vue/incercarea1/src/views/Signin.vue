        ...
        <b-row>
            ...
            <b-jumbotron header lead="Register form">
              ...
              <b-form-group label="Username*">
                ...
                <b-form-invalid-feedback :state="!userError"
                  >This username already exists!. Please chose other
                  unsername</b-form-invalid-feedback
                >
              </b-form-group>
              ...
              <b-form-group label="Employer's CODE*" v-if="role === 'employee'">
                ...
                <b-form-invalid-feedback :state="!codeError"
                  >This code is invalid!</b-form-invalid-feedback
                >
              </b-form-group>
          ...
          <b-col sm="4">
            <b-jumbotron header lead>
              <b-form-group
                label="Birthdate* (dd/MM/yyyy) & time of birth (HH:mm)"
                inline
              >
                <b-form-select
              ...
              <b-form-invalid-feedback :state="!formIsInvalid"
                >Form is not valid!</b-form-invalid-feedback
              >
            </b-jumbotron>
          </b-col>
        </b-row>
