    ...
    <b-container>
      <em>
        *The following information was taken from
        <a
          href="https://www.russellrowe.com/"
        >Russell Rowe's Healthy &amp; Happy Wellness Services</a> website
      </em>
      ...
      <b-card class="mt-4" header-tag="header">
        ...
        <b-card-text class="about-mbti">
          <h5
            class="lead"
          >"The Jungian-Keirsey System" is a system that combines the best of two personality type theories together - The Psychological Type Theory postulated by Carl Jung and the Keirsey Temperament Theory postulated by David Keirsey.</h5>
          <br />
          <p>Carl Jung, a Swiss psychoanalyst, is credited with developing the personality type theory model that was published in 1923 in a book called "Psychological Types." At about the same time a woman named Katharine Briggs was developing her own theory of personalities by reading biographies and observing people she knew. When Katharine read Carl Jung's book she saw that his theory was consistent with hers in every way but was more complete. She, along with her daughter Isabel Myers, began studying the work of Carl Jung in earnest and eventually added their own concepts to his work, creating the Myers-Briggs System, which is a system of 16 different Myers-Briggs types. Interestingly, each of David Keirsey's four temperaments describe exactly four of Briggs and Myers types.</p>
          <p>Isabel Myers believed that if people could learn to understand and accept each other's differences that peace could be achieved in the world. So, when World War II began to rip the world apart, Isabel Myers, along with help from her mother, began developing a type indicator that would help people determine their psychological preferences so that they could find work that fully utilized their inborn talents and thus be most effective in the war effort.</p>
          <p>For two decades the type indicator they developed, later known as the Myers-Briggs Type Indicator (MBTI), was tested on college and medical school students to ensure reliability and validity before bringing it to a much wider audience. Until 1975 the MBTI was only available for research purposes. In 1975 Consulting Psychologists Press (CPP) took over publishing the MBTI and made it available to qualified practitioners that had been through a training course on the Myers-Briggs system. It was at that time that the MBTI became available to anyone, through these qualified practitioners.</p>
          <p>The Jungian-Keirsey system is a personality system that's based on the personality type theory model first developed by the famous Swiss psychoanalyst, Carl G. Jung, and later expanded by a mother and daughter team, Katharine Briggs and Isabel Myers. It is also based on the temperament theory work of David Keirsey. Carl Jung's model was explained in detail in his book, "Psychological Types" that was published in 1923. David Keirsey's model was explained best in his book, "Please Understand Me II" that was published in 1998, 20 years after his first book, "Please Understand Me." Like all of the systems on this website, the Jungian-Keirsey system is universal and applies equally well to everyone in the world - it is not limited to race, culture or creed. It describes different personality styles and behavioral characteristics extremely well and has a multitude of uses in real life</p>
          <p>The Jungian-Keirsey system was designed to help people value and appreciate themselves and others. Each Jungian-Keirsey type has individual patterns of behavior and character that are distinct from all other types. In some cases the behavior of two (or more) types is similar but the motivations behind that behavior are always different due to the different mental processes that dominate each unique type.</p>
          <p>In this system there are 16 different personality types that cluster into 4 different temperament categories (4 types to each temperament category). For simplicity, I have chosen to use the Myers-Briggs 4-letter acronyms to describe each of my Jungian-Keirsey types because it is a nice, short descriptor. The 4-letter acronyms will be meaningful once you understand "How the Jungian-Keirsey System Works".</p>
        </b-card-text>
        <!--True Blue -->
          ...
          <b-card-group deck>
            ...
            <b-card class="enfp" header-tag="header" footer-tag="footer">
              ...
              <b-modal id="enfp" size="lg" title="ENFP" hide-footer>
                ...
                <b-button class="mt-3 float-right" @click="$bvModal.hide('enfp')">Close</b-button>
              </b-modal>
            </b-card>
            <!--INFJ -->
            <b-card class="infj" header-tag="header" footer-tag="footer">
              ...
              <b-modal id="infj" size="lg" title="INFJ" hide-footer>
                ...
                <b-button class="mt-3 float-right" @click="$bvModal.hide('infj')">Close</b-button>
              </b-modal>
            </b-card>
            <!--INFP -->
            <b-card class="infp" header-tag="header" footer-tag="footer">
              ...
              <b-modal id="infp" size="lg" title="INFP" hide-footer>
                <b-tabs content-class="mt-2 text-justify" small>
                  <b-tab title="Description" style="text-indent: 40px;" active>
                    <p>Above all INFPs want an external life that's congruent with their values. INFPs are reserved, sensitive, creative, curious, sacrificial and adaptable. Like all True Blues, INFPs seek to understand people and help them fulfill their potential. They have passionate convictions and strong ideals. They are contemplative, philosophical and enjoy exploring moral questions. INFPs have a talent for facilitative listening and knowing the truth behind what is being said. They dislike rules, schedules and deadlines and sometimes struggle with structure and getting their lives in order. INFPs are calm and gentle and able to go with the flow, unless one of their core values is threatened.</p>
                  </b-tab>
                  <b-tab title="Temperament Combinations">
                    <b-tabs content-class="mt-2 text-justify" pills vertical small>
                      <b-tab title="True Blue/Deep Green" style="text-indent: 40px;">
                ...
                <b-button class="mt-3 float-right" @click="$bvModal.hide('infp')">Close</b-button>
              </b-modal>
            </b-card>
          </b-card-group>
        </b-col>
          ...
          <b-card-group deck>
            ...
            <b-card class="entp" header-tag="header" footer-tag="footer">
              ...
              <b-modal id="entp" size="lg" title="ENTP" hide-footer>
                ...
                <b-button class="mt-3 float-right" @click="$bvModal.hide('entp')">Close</b-button>
              </b-modal>
            </b-card>
            ...
            <b-card class="intj" header-tag="header" footer-tag="footer">
              ...
              <b-modal id="intj" size="lg" title="INTJ" hide-footer>
                <b-tabs content-class="mt-2 text-justify" small>
                  <b-tab title="Description" style="text-indent: 40px;" active>
                    <p>INTJs are driven for self-improvement and maximizing achievements. They are insightful, visionary, skeptical, independent, and individualistic. They have original, theoretical, scientific minds and are ingenious at creative problem solving. They are most skilled in creating theories and systems. They quickly see patterns in external events and develop long-range strategies for implementing their ideas and achieving their goals. They're intense, single-minded, and determined. They have high standards of competence and performance - for themselves and others. They're responsible, organized and good at follow through. They're reserved and private.</p>
                  </b-tab>
                  <b-tab title="Temperament Combinations">
                    <b-tabs content-class="mt-2 text-justify" pills vertical small>
                      <b-tab title="Deep Green/True Blue" style="text-indent: 40px;">
                ...
                <b-button class="mt-3 float-right" @click="$bvModal.hide('intj')">Close</b-button>
              </b-modal>
            </b-card>
            ...
            <b-card class="intp" header-tag="header" footer-tag="footer">
              ...
              <b-modal id="intp" size="lg" title="INTP" hide-footer>
                <b-tabs content-class="mt-2 text-justify" small>
                  <b-tab title="Description" style="text-indent: 40px;" active>
                    <p>INTPs are the masters of conceptual logic. They are abstract, scientific, original thinkers who seek to develop logical explanations for everything that interests them. They often want to understand how everything in the universe works. They are idiosyncratic, nonconforming and very independent. They are curious, analytical and insightful. They naturally notice inconsistencies, contradictions and flaws of logic in others' thinking. INTPs are also private and introspective. They can be so caught up in thought that they can struggle with attending to the physical world. They've been accused of being absent-minded, like Albert Einstein, a quintessential INTP.</p>
                  </b-tab>
                  <b-tab title="Temperament Combinations">
                    <b-tabs content-class="mt-2 text-justify" pills vertical small>
                      <b-tab title="Deep Green/True Blue" style="text-indent: 40px;">
                ...
                <b-button class="mt-3 float-right" @click="$bvModal.hide('intp')">Close</b-button>
              </b-modal>
            </b-card>
          </b-card-group>
        </b-col>
          ...
          <b-card-group deck>
            ...
            <b-card class="esfj" header-tag="header" footer-tag="footer">
              ...
              <b-modal id="esfj" size="lg" title="ESFJ" hide-footer>
                ...
                <b-button class="mt-3 float-right" @click="$bvModal.hide('esfj')">Close</b-button>
              </b-modal>
            </b-card>
            <!--ISTJ -->
            <b-card class="istj" header-tag="header" footer-tag="footer">
              ...
              <b-modal id="istj" size="lg" title="ISTJ" hide-footer>
                ...
                <b-button class="mt-3 float-right" @click="$bvModal.hide('istj')">Close</b-button>
              </b-modal>
            </b-card>
            <!--ISFJ -->
            <b-card class="isfj" header-tag="header" footer-tag="footer">
              ...
              <b-modal id="isfj" size="lg" title="ISFJ" hide-footer>
                ...
                <b-button class="mt-3 float-right" @click="$bvModal.hide('isfj')">Close</b-button>
              </b-modal>
            </b-card>
          </b-card-group>
        </b-col>
          ...
          <b-card-group deck>
            ...
            <b-card class="esfp" header-tag="header" footer-tag="footer">
              ...
              <b-modal id="esfp" size="lg" title="ESFP" hide-footer>
                ...
                <b-button class="mt-3 float-right" @click="$bvModal.hide('esfp')">Close</b-button>
              </b-modal>
            </b-card>
            <!--ISTP -->
            <b-card class="istp" header-tag="header" footer-tag="footer">
              ...
              <b-modal id="istp" size="lg" title="ISTP" hide-footer>
                ...
                <b-button class="mt-3 float-right" @click="$bvModal.hide('istp')">Close</b-button>
              </b-modal>
            </b-card>
            <!--ISFP -->
            <b-card class="isfp" header-tag="header" footer-tag="footer">
              ...
              <b-modal id="isfp" size="lg" title="ISFP" hide-footer>
                ...
                <b-button class="mt-3 float-right" @click="$bvModal.hide('isfp')">Close</b-button>
              </b-modal>
            </b-card>
          </b-card-group>
        </b-col>
