            ...
            <div>
              ...
              >
                ...
                <template v-slot:cell(actions)="row">
                  <b-button
                    :variant="row.detailsShowing ? 'info' : 'outline-info'"
                    size="sm"
...
export default {
  ...
  methods: {
    ...
    getYourTeam() {
      let employer = this.getAllUsers.filter(
        us => us.code === this.getLoginUser.employerCode
      )[0];
      let fellows = this.getAllUsers.filter(
        us => us.teamName === this.getLoginUser.teamName
      );
